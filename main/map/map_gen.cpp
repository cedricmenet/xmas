...
map_gen::map_gen(const map_gen &cp)
{
    ...
    m_b.objs_p1_s = cp.m_b.objs_p1_s;
    ...
    m_b.objs_p2_s = cp.m_b.objs_p2_s;
    ...
    m_b.objs_p1_active_length =3;
    for(int i =0; i < 3;i++)
    {
        m_b.objs_p1_active[i] = cp.m_b.objs_p1_active[i];
    }
    m_b.objs_p2_active_length =3;
    for(int i =0; i < 3;i++)
    {
